...
public class PermissionChecker : AuthorizeAttribute, IAsyncAuthorizationFilter
{
    ...
    {
        _permission = permission; //It becomes the element that We send To it
    }
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        _userFacade = context.HttpContext.RequestServices.GetRequiredService<IUserFacade>(); //We Cannot get them From constructor So we get Them From this method
