...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20250101070739_testToken")]
    partial class testToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shop.Domain.CategoryAgg.Category", b =>
                {
                    ...
                    b.OwnsOne("Common.Domain.ValueObject.SeoData", "SeoData", b1 =>
                        {
                    ...
                    b.OwnsMany("Shop.Domain.UserAgg.UserAddress", "Addresses", b1 =>
                        {
                            ...
                            b1.OwnsOne("Common.Domain.ValueObject.PhoneNumber", "PhoneNumber", b2 =>
                                {
